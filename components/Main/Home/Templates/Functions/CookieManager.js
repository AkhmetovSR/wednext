...
//     useEffect(() => {
//         const savedTheme = CookieManager.get('user_theme');
//         if (savedTheme) {
...
//         CookieManager.set('user_theme', theme, {
//             expires: 30, // 30 дней
//             path: '/',
//             sameSite: 'Strict',
//             secure: true
...
//                 CookieManager.remove('user_theme', '/');
//                 setUserTheme('light');
//             }}>
//                 Reset Preferences
//             </button>
...
//     // Запись куки
//     CookieManager.set('auth_token', userData.token, {
//         expires: 1, // 1 день
//         secure: true,
//         sameSite: 'Strict'
//     });
